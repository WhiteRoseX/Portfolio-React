        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            >
              ...
              <h4 className="text-2xl font-semibold text-teal-400 mb-4">Jeux d'échecs</h4>
              <p>
            ...
            >
              ...
              <h4 className="text-2xl font-semibold text-teal-400 mb-4">Informatique</h4>
              <p>
            ...
            >
              ...
              <h4 className="text-2xl font-semibold text-teal-400 mb-4">Salle de sport</h4>
              <p>
